...
export const DAILY_HUNGER_LOSS = 15; // Increased from 2 to 15 for a meaningful survival buffer
...
export const JOB_CATEGORIES: Record<string, string[]> = {
    ...
    "기술/생산 (Tech/Production)": [
        "개발자", "기술자(엔지니어)", "목수", "배관공", "정비공", "농부", "사육사", "요리사", "어부", "바리스타", "바텐더"
    ],
    "전문직/사무 (Professional)": [
        "회사원", "공무원", "변호사", "판사", "검사", "정치인", "기자", "비서", "교사/교수", "회계사", "영업직"
    ],
    "예술/연예 (Arts/Entertainment)": [
        "연예인", "가수", "배우", "아이돌", "만화가/웹툰작가", "작가", "발레리나/무용수", "광대", "미식가", "화가", "음악가"
    ],
