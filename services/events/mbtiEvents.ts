...
export const MBTI_EVENT_POOL: Record<MBTI, MBTIEventGenerator[]> = {
    INTJ: [
        ...
        (n, p) => ({ text: `${n}은(는) 바리케이드를 보강하다 낡은 철사에 찔려 파상풍과 감염의 위험에 노출되었습니다.`, hp: -2, infection: 5, fatigue: 15 }),
        (n, p) => ({ text: `${n}은(는) ${p}의 냉철한 판단으로 함정을 미리 감지하고 피해갔습니다.`, fatigue: 5 }),
        (n, p) => ({ text: `${n}은(는) 혼자만의 시간을 가지며 복잡한 머릿속을 정리했습니다.`, sanity: 10, fatigue: -5 }),
        (n, p) => ({ text: `${n}은(는) 좀비 시체를 해부하여 약점을 연구하다가 실수로 손을 베였습니다!`, hp: -5, infection: 10, sanity: 5 }),
        ...
        (n, p) => ({ text: `${n}은(는) 좀비와의 근접전 중 계산 착오로 팔을 물렸습니다.`, hp: -10, infection: 15, fatigue: 10 })
    ],
    INTP: [
        ...
        (n, p) => ({ text: `${n}은(는) 좀비의 행동 양식을 관찰하려다 너무 가까이 다가가 긁혔습니다.`, hp: -5, infection: 10, fatigue: 10 }),
        ...
        (n, p) => ({ text: `${n}은(는) 좀비의 타액 샘플을 채취하다가 피부에 닿았습니다!`, hp: -2, infection: 15, sanity: -5 }),
        ...
        (n, p) => ({ text: `${n}은(는) 실험적으로 만든 무기가 폭발하여 파편에 맞았습니다.`, hp: -10, infection: 5, fatigue: 10 })
    ],
    ENTJ: [
        (n, p) => ({ text: `${n}은(는) 생존자들을 효율적으로 지휘하여 완벽한 방어선을 구축했습니다.`, sanity: 5, fatigue: 15 }),
        (n, p) => ({ text: `${n}은(는) 자원 확보를 위해 위험한 원정을 강행했다가 부상을 입고 돌아왔습니다.`, hp: -10, infection: 10, kill: 2, fatigue: 20 }),
        ...
        (n, p) => ({ text: `${n}은(는) 선두에 서서 좀비 무리를 뚫다가 팔을 물렸지만, 내색하지 않고 지휘했습니다.`, hp: -15, infection: 20, kill: 3 }),
    ...
    ENTP: [
        (n, p) => ({ text: `${n}은(는) 좀비를 유인하는 위험한 장난을 치다가 손가락을 물렸습니다.`, hp: -5, infection: 15, kill: 1, fatigue: 15 }),
        ...
        (n, p) => ({ text: `${n}은(는) 좀비 한 마리를 생포해서 길들이려다 크게 다칠 뻔했습니다.`, hp: -5, infection: 5, sanity: -5 }),
        ...
        (n, p) => ({ text: `${n}은(는) 호기심에 감염된 혈액을 만져보았습니다.`, infection: 10, sanity: -2 })
    ],
    ...
    INFJ: [
        ...
        (n, p) => ({ text: `${n}은(는) 좀비가 된 옛 이웃을 보고 다가가려다 긁혔습니다.`, hp: -5, infection: 10, sanity: -15 }),
        ...
        (n, p) => ({ text: `${n}은(는) 아이들을 지키기 위해 몸을 던져 대신 물렸습니다.`, hp: -10, infection: 20, sanity: 5 }),
        ...
        (n, p) => ({ text: `${n}은(는) 좀비의 피가 튄 옷을 계속 입고 있어 감염 위험이 높아졌습니다.`, infection: 5, sanity: -5 }),
    ...
    INFP: [
        ...
        (n, p) => ({ text: `${n}은(는) 다친 길고양이를 치료하려다 할퀴어져 상처가 덧났습니다.`, hp: -5, infection: 5, fatigue: 5 }),
        (n, p) => ({ text: `${n}은(는) 모두가 행복하게 사는 이상적인 은신처를 상상했습니다.`, fatigue: 0 }),
        (n, p) => ({ text: `${n}은(는) 소중한 물건을 잃어버리고 하루 종일 우울해했습니다.`, sanity: -5, fatigue: 10 }),
        (n, p) => ({ text: `${n}은(는) 좀비에게도 영혼이 남아있을지 모른다고 생각하며 주저하다 위험에 처했습니다.`, hp: -5, infection: 5, sanity: -2 }),
        ...
        (n, p) => ({ text: `${n}은(는) 좀비의 습격을 멍하니 바라보다가 팔을 물렸습니다.`, hp: -10, infection: 15, sanity: -15 }),
    ...
    ENFJ: [
        ...
        (n, p) => ({ text: `${n}은(는) 동료를 구하기 위해 위험을 무릅쓰고 뛰어들어 상처를 입었습니다.`, hp: -15, infection: 10, sanity: 10 }),
        ...
        (n, p) => ({ text: `${n}은(는) 죽은 동료의 시신을 수습하다가 감염된 혈액에 노출되었습니다.`, infection: 5, sanity: -5 }),
        ...
        (n, p) => ({ text: `${n}은(는) 모두가 탈출할 시간을 벌기 위해 홀로 좀비 떼를 막아내다 물렸습니다.`, kill: 2, hp: -20, infection: 25, fatigue: 30 }),
    ...
    ENFP: [
        ...
        (n, p) => ({ text: `${n}은(는) 충동적으로 낯선 건물에 들어갔다가 좀비에게 쫓겨 상처를 입었습니다.`, hp: -5, infection: 5, sanity: 5 }),
        ...
        (n, p) => ({ text: `${n}은(는) 호기심을 참지 못하고 오염 구역에 들어갔다가 감염 위험에 노출되었습니다.`, hp: -2, infection: 10, sanity: -2 }),
        ...
        (n, p) => ({ text: `${n}은(는) 쏟아지는 비를 맞으며 춤을 추다가 감기에 걸렸습니다.`, hp: -5, sanity: 5 }),
    ...
    ISTJ: [
        ...
        (n, p) => ({ text: `${n}은(는) 과거의 경험을 되살려 오래된 발전기를 수리하다가 손을 다쳤습니다.`, hp: -5, infection: 5, sanity: 5 }),
        ...
        (n, p) => ({ text: `${n}은(는) 좀비 시체를 처리하다가 규정을 지키지 않아 감염될 뻔했습니다.`, infection: 5, sanity: -2 })
    ],
    ISFJ: [
        ...
        (n, p) => ({ text: `${n}은(는) 위기의 순간 자신의 안위보다 동료의 방패가 되기를 자처해 부상을 입었습니다.`, hp: -15, infection: 10, fatigue: 15 }),
        ...
        (n, p) => ({ text: `${n}은(는) 환자를 돌보다가 피가 튀어 감염 위험에 노출되었습니다.`, infection: 10, sanity: -5 }),
    ...
    ESTJ: [
        ...
        (n, p) => ({ text: `${n}은(는) 감염 예방 수칙을 어긴 사람을 강제로 격리하다가 실랑이가 벌어졌습니다.`, hp: -2, infection: 5, sanity: -5 }),
    ...
    ESFJ: [
        ...
        (n, p) => ({ text: `${n}은(는) 오염된 식재료를 손질하다가 손을 베였습니다.`, infection: 5, hp: -2 }),
    ...
    ISTP: [
        ...
        (n, p) => ({ text: `${n}은(는) 혼자 정찰을 나갔다가 좀비 무리와 근접전을 벌여 피투성이가 되었습니다.`, hp: -10, infection: 15, kill: 2, fatigue: 20 }),
        ...
        (n, p) => ({ text: `${n}은(는) 무기를 손질하다가 날카로운 부분에 손을 베였습니다.`, hp: -2, infection: 5 })
    ],
    ISFP: [
        ...
        (n, p) => ({ text: `${n}은(는) 다친 사슴을 발견하고 치료해주려 노력하다가 물릴 뻔했습니다.`, sanity: 5, infection: 5, fatigue: 10 }),
        ...
        (n, p) => ({ text: `${n}은(는) 예기치 못한 순간에 용기를 발휘해 동료를 구하고 부상을 입었습니다.`, hp: -10, infection: 10, sanity: 5, fatigue: 15 }),
    ...
    ESTP: [
        (n, p) => ({ text: `${n}은(는) 위험한 상황을 즐기며 좀비와 추격전을 벌이다 찰과상을 입었습니다.`, hp: -10, infection: 10, kill: 2, fatigue: 25 }),
        ...
        (n, p) => ({ text: `${n}은(는) 좀비 떼 한가운데로 뛰어들어 무쌍을 찍었지만 심하게 다쳤습니다.`, hp: -20, infection: 25, kill: 10, fatigue: 40 }),
        ...
        (n, p) => ({ text: `${n}은(는) 위험한 구역에 가장 먼저 뛰어들었습니다.`, hp: -5, infection: 5, fatigue: 20 }),
    ...
    ESFP: [
        ...
        (n, p) => ({ text: `${n}은(는) 충동적으로 닫힌 문을 열었다가 좀비에게 팔을 긁혔습니다.`, hp: -10, infection: 10, sanity: -5, fatigue: 15 }),
        ...
        (n, p) => ({ text: `${n}은(는) 좀비 흉내를 내며 장난치다가 진짜 좀비에게 들켜 쫓겼습니다.`, hp: -5, infection: 5, sanity: -5, fatigue: 10 }),
