...
export const BUNKER_NODES: Record<string, StoryNode> = {
    ...
    // Depth 2: 입구 발견 (Added Choice with Requirements)
    'bunker_2_entrance': {
        ...
        next: [
            ...
            { id: 'bunker_3_hack_tech', weight: 0.0, choiceText: "우회 회로 연결 (기술자 필요)", req: { job: '기술자(엔지니어)' } }, // Alias for Hack
    ...
    'bunker_3_hack': {
        ...
        effect: { target: 'ALL', sanity: 5 } // Bonus for smart play
    },
    'bunker_3_hack_tech': { // Same result
    ...
    'bunker_7_destroy': {
        id: 'bunker_7_destroy',
        text: "💥 엄폐물 뒤에서 권총으로 포탑의 센서를 정확히 사격했습니다. 포탑이 불꽃을 튀기며 작동을 멈춥니다.",
        next: [{ id: 'bunker_8_lab', weight: 1.0 }],
        effect: { target: 'ALL', fatigue: 5 } // Less fatigue
    },
    'bunker_7_soldier': {
        id: 'bunker_7_soldier',
    ...
    'bunker_10_reactor': {
        ...
        next: [
            ...
            { id: 'bunker_11_meltdown', weight: 0.5 } // Hidden fail outcome for random choice
        ],
    ...
    'bunker_11_success_random': {
        id: 'bunker_11_success_random', // Reusing success logic
    ...
    'bunker_11_success': { // Fallback for old saves or generic flow
