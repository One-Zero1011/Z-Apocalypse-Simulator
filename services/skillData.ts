...
/* Fix: JOB_SKILLS was missing, leading to the error. Added job-to-skill mappings. */
// --- 직업별 초기 스킬 설정 ---
export const JOB_SKILLS: Record<string, Skill[]> = {
    "군인": [SKILLS.MARKSMANSHIP, SKILLS.TACTICAL_COMMAND],
    "경찰": [SKILLS.LAW_ENFORCEMENT, SKILLS.MELEE_COMBAT],
    "형사": [SKILLS.INVESTIGATION, SKILLS.MARKSMANSHIP],
    "소방관": [SKILLS.ATHLETICS, SKILLS.FIRST_AID],
    "경호원": [SKILLS.DEFENSE_STANCE, SKILLS.MELEE_COMBAT],
    "용병": [SKILLS.WEAPON_MAINTENANCE, SKILLS.MARKSMANSHIP],
    "교도관": [SKILLS.LAW_ENFORCEMENT, SKILLS.MELEE_COMBAT],
    "사냥꾼": [SKILLS.HUNTING, SKILLS.STEALTH],
    "탐정": [SKILLS.INVESTIGATION, SKILLS.SENSORY],
    
    "의사": [SKILLS.SURGERY, SKILLS.ANATOMY_KNOWLEDGE],
    "간호사": [SKILLS.FIRST_AID, SKILLS.HYGIENE_CONTROL],
    "수의사": [SKILLS.ANATOMY_KNOWLEDGE, SKILLS.DETOX],
    "약사": [SKILLS.PHARMACOLOGY, SKILLS.DETOX],
    "심리상담사": [SKILLS.MENTAL_CARE, SKILLS.TRAUMA_RELIEF],
    "연구원": [SKILLS.PHARMACOLOGY, SKILLS.HACKING],
    "응급구조사": [SKILLS.FIRST_AID, SKILLS.AGILITY],
    "물리치료사": [SKILLS.ANATOMY_KNOWLEDGE, SKILLS.ATHLETICS],
    ...
    "농부": [SKILLS.FARMING, SKILLS.FORAGING],
    "사육사": [SKILLS.LIVESTOCK, SKILLS.HUNTING],
    "요리사": [SKILLS.COOKING, SKILLS.HYGIENE_CONTROL],
    "어부": [SKILLS.FISHING, SKILLS.SURVIVAL_INSTINCT],
    "바리스타": [SKILLS.COOKING, SKILLS.PERFORMANCE],
    "바텐더": [SKILLS.PHARMACOLOGY, SKILLS.MENTAL_CARE],

    "회사원": [SKILLS.ADMINISTRATION, SKILLS.LOGISTICS],
    "공무원": [SKILLS.ADMINISTRATION, SKILLS.LAW_ENFORCEMENT],
    "변호사": [SKILLS.NEGOTIATION, SKILLS.LAW_ENFORCEMENT],
    "판사": [SKILLS.LAW_ENFORCEMENT, SKILLS.PLANNING],
    "검사": [SKILLS.INVESTIGATION, SKILLS.LAW_ENFORCEMENT],
    "정치인": [SKILLS.LEADERSHIP, SKILLS.PUBLIC_RELATIONS],
    ...
    "연예인": [SKILLS.PERFORMANCE, SKILLS.ACTING],
    "가수": [SKILLS.MUSIC, SKILLS.PERFORMANCE],
    "배우": [SKILLS.ACTING, SKILLS.PERFORMANCE],
    "아이돌": [SKILLS.PERFORMANCE, SKILLS.AGILITY],
    "만화가/웹툰작가": [SKILLS.ARTISTIC, SKILLS.CRAFTING],
    "작가": [SKILLS.ARTISTIC, SKILLS.PLANNING],
    "발레리나/무용수": [SKILLS.ACROBATIC, SKILLS.AGILITY],
    "광대": [SKILLS.PERFORMANCE, SKILLS.LUCK],
    "미식가": [SKILLS.COOKING, SKILLS.SENSORY],
    "화가": [SKILLS.ARTISTIC, SKILLS.SENSORY],
    "음악가": [SKILLS.MUSIC, SKILLS.SENSORY],

    "미용사": [SKILLS.CRAFTING, SKILLS.PERFORMANCE],
    "호텔리어": [SKILLS.ADMINISTRATION, SKILLS.SECRETARY],
    "승무원": [SKILLS.FIRST_AID, SKILLS.SECRETARY],
    "택시기사": [SKILLS.DRIVING, SKILLS.SENSORY],
    "배달원": [SKILLS.DRIVING, SKILLS.AGILITY],
    "유튜버/스트리머": [SKILLS.PERFORMANCE, SKILLS.REPORTING],
    "프로게이머": [SKILLS.GAMER_REFLEX, SKILLS.LUCK],
    ...
    "수녀": [SKILLS.SPIRITUALITY, SKILLS.FIRST_AID],

    "대학생": [SKILLS.POTENTIAL, SKILLS.TEACHING],
    "고등학생": [SKILLS.POTENTIAL, SKILLS.AGILITY],
    "중학생": [SKILLS.POTENTIAL, SKILLS.GAMER_REFLEX],
    "초등학생": [SKILLS.POTENTIAL, SKILLS.LUCK],
    "백수": [SKILLS.LUCK, SKILLS.SCAVENGING],
    "거지/노숙자": [SKILLS.SCAVENGING, SKILLS.SURVIVAL_INSTINCT],
    "조폭/마피아": [SKILLS.MELEE_COMBAT, SKILLS.AMBUSH],
    "도박사": [SKILLS.LUCK, SKILLS.NEGOTIATION],
    "죄수": [SKILLS.MELEE_COMBAT, SKILLS.INFILTRATION],
    "아기": [SKILLS.POTENTIAL, SKILLS.SURVIVAL_INSTINCT]
};
